             ...
             <h1 class="section-heading"><i class="fa fa-paw" aria-hidden="true"></i> HELP US STOP <i class="fa fa-paw" aria-hidden="true"></i></h1> <br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                        <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-warning"></i>
                        <i class="fa fa-thermometer-empty fa-stack-1x fa-inverse"></i>
                        </span>
        ...
        <section class="jump-to-next-section"  id="donate">
            ...
            <div class="row">
                <p class="section-content">
                    ...
                    Activist groups are working hard to maintain habitats where the tigers can mate and increase in number. By focusing on areas where the tigers have the best chance of survival, activists are hoping that political changes and proper funding will allow tigers to grow in number.  <br>
                    Build reservation parks and breeding ground which are danger free, in the hope that tiger population will continue to grow exponentially.<br>
                    All the actions undertaken require a lot of effort, time and resources. Non-activists can help by donating money to help protect habitats and establish new breeding grounds.<br>
